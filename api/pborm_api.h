...
int         pborm_batch_get(const google::protobuf::Message & msg, const char * where = nullptr, int offset = 0, int limit = 0 , const char * cb_data = 0, int cb_size = 0);
