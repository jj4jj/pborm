...
class Config : public ::google::protobuf::Message {
 public:
  ...
  // repeated string meta_files = 103;
  inline int meta_files_size() const;
  inline void clear_meta_files();
  static const int kMetaFilesFieldNumber = 103;
  inline const ::std::string& meta_files(int index) const;
  inline ::std::string* mutable_meta_files(int index);
  inline void set_meta_files(int index, const ::std::string& value);
  inline void set_meta_files(int index, const char* value);
  inline void set_meta_files(int index, const char* value, size_t size);
  inline ::std::string* add_meta_files();
  inline void add_meta_files(const ::std::string& value);
  inline void add_meta_files(const char* value);
  inline void add_meta_files(const char* value, size_t size);
  inline const ::google::protobuf::RepeatedPtrField< ::std::string>& meta_files() const;
  inline ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_meta_files();
 ...
 private:
  ...
  ::std::string* listen_;
  ::google::protobuf::RepeatedPtrField< ::std::string> meta_files_;
...
// repeated string meta_files = 103;
inline int Config::meta_files_size() const {
  return meta_files_.size();
}
inline void Config::clear_meta_files() {
  meta_files_.Clear();
}
inline const ::std::string& Config::meta_files(int index) const {
  // @@protoc_insertion_point(field_get:pborm.Config.meta_files)
  return meta_files_.Get(index);
}
inline ::std::string* Config::mutable_meta_files(int index) {
  // @@protoc_insertion_point(field_mutable:pborm.Config.meta_files)
  return meta_files_.Mutable(index);
}
inline void Config::set_meta_files(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:pborm.Config.meta_files)
  meta_files_.Mutable(index)->assign(value);
}
inline void Config::set_meta_files(int index, const char* value) {
  meta_files_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:pborm.Config.meta_files)
}
inline void Config::set_meta_files(int index, const char* value, size_t size) {
  meta_files_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:pborm.Config.meta_files)
}
inline ::std::string* Config::add_meta_files() {
  return meta_files_.Add();
}
inline void Config::add_meta_files(const ::std::string& value) {
  meta_files_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:pborm.Config.meta_files)
}
inline void Config::add_meta_files(const char* value) {
  meta_files_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:pborm.Config.meta_files)
}
inline void Config::add_meta_files(const char* value, size_t size) {
  meta_files_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:pborm.Config.meta_files)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
Config::meta_files() const {
  // @@protoc_insertion_point(field_list:pborm.Config.meta_files)
  return meta_files_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
Config::mutable_meta_files() {
  // @@protoc_insertion_point(field_mutable_list:pborm.Config.meta_files)
  return &meta_files_;
}
