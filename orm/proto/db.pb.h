...
class DBTest : public ::google::protobuf::Message {
 public:
  ...
  // @@protoc_insertion_point(class_scope:test.DBTest)
 private:
...
inline ::google::protobuf::uint64 DBTest::role_id() const {
  // @@protoc_insertion_point(field_get:test.DBTest.role_id)
  return role_id_;
}
inline void DBTest::set_role_id(::google::protobuf::uint64 value) {
  set_has_role_id();
  role_id_ = value;
  // @@protoc_insertion_point(field_set:test.DBTest.role_id)
}
...
inline ::google::protobuf::uint32 DBTest::seq() const {
  // @@protoc_insertion_point(field_get:test.DBTest.seq)
  return seq_;
}
inline void DBTest::set_seq(::google::protobuf::uint32 value) {
  set_has_seq();
  seq_ = value;
  // @@protoc_insertion_point(field_set:test.DBTest.seq)
}
...
inline const ::CommBase& DBTest::base() const {
  // @@protoc_insertion_point(field_get:test.DBTest.base)
  return base_ != NULL ? *base_ : *default_instance_->base_;
}
inline ::CommBase* DBTest::mutable_base() {
  set_has_base();
  if (base_ == NULL) base_ = new ::CommBase;
  // @@protoc_insertion_point(field_mutable:test.DBTest.base)
  return base_;
}
...
inline void DBTest::set_allocated_base(::CommBase* base) {
  ...
  // @@protoc_insertion_point(field_set_allocated:test.DBTest.base)
}
