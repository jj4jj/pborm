...
void protobuf_AssignDesc_pborm_5fconf_2eproto() {
  ...
  static const int Config_offsets_[7] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(Config, meta_files_),
  };
  Config_reflection_ =
    new ::google::protobuf::internal::GeneratedMessageReflection(
      Config_descriptor_,
...
void protobuf_AddDesc_pborm_5fconf_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "daemon\030\002 \001(\r:\0010\"\360\001\n\006Config\022\033\n\003log\030\001 \001(\0132"
    ...
    " \003(\tB\014\232\265\030\00232\222\265\030\00216", 858);
...
const int Config::kMetaFilesFieldNumber;
#endif  // !_MSC_VER
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 102: {
        ...
        if (input->ExpectTag(826)) goto parse_meta_files;
        break;
      }
      ...
      case 103: {
        if (tag == 826) {
         parse_meta_files:
          DO_(::google::protobuf::internal::WireFormatLite::ReadString(
                input, this->add_meta_files()));
          ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
            this->meta_files(this->meta_files_size() - 1).data(),
            this->meta_files(this->meta_files_size() - 1).length(),
            ::google::protobuf::internal::WireFormat::PARSE,
            "meta_files");
        } else {
          goto handle_unusual;
...
void Config::SerializeWithCachedSizes(
  ...
  // repeated string meta_files = 103;
  for (int i = 0; i < this->meta_files_size(); i++) {
  ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
    this->meta_files(i).data(), this->meta_files(i).length(),
    ::google::protobuf::internal::WireFormat::SERIALIZE,
    "meta_files");
    ::google::protobuf::internal::WireFormatLite::WriteString(
      103, this->meta_files(i), output);
  }
...
::google::protobuf::uint8* Config::SerializeWithCachedSizesToArray(
  ...
  for (int i = 0; i < this->meta_files_size(); i++) {
    ::google::protobuf::internal::WireFormat::VerifyUTF8StringNamedField(
      ...
      "meta_files");
    target = ::google::protobuf::internal::WireFormatLite::
      WriteStringToArray(103, this->meta_files(i), target);
  }
...
int Config::ByteSize() const {
  ...
  // repeated string meta_files = 103;
  total_size += 2 * this->meta_files_size();
  for (int i = 0; i < this->meta_files_size(); i++) {
...
void Config::MergeFrom(const Config& from) {
  GOOGLE_CHECK_NE(&from, this);
  meta_files_.MergeFrom(from.meta_files_);
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    if (from.has_log()) {
...
void Config::Swap(Config* other) {
  if (other != this) {
    ...
    meta_files_.Swap(&other->meta_files_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
